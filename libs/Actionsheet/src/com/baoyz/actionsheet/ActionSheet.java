...
public class ActionSheet extends Fragment implements OnClickListener {
    ...
    private static final String ARG_OTHER_BUTTON_IMAGES = "other_button_images";
    ...
    private void createItems() {
        ...
        int[] imageResIDs = getOtherButtonImages();

        if (titles != null) {
            for (int i = 0; i < titles.length; i++) {
                RelativeLayout layoutItem = new RelativeLayout(getActivity());
                layoutItem.setBackgroundDrawable(getOtherButtonBg(titles, i));
                layoutItem.setOnClickListener(this);
                layoutItem.setId(CANCEL_BUTTON_ID + i + 1);

                LinearLayout layoutCenter = new LinearLayout(getActivity());
                layoutCenter.setOrientation(LinearLayout.HORIZONTAL);

                if (imageResIDs != null && i < imageResIDs.length) {
                    ...
                    image_params.rightMargin = mAttrs.actionSheetImageMarginRight;

                    layoutCenter.addView(imageView, image_params);
                }
                ...
                layoutCenter.addView(bt, button_params);

                RelativeLayout.LayoutParams center_params = new RelativeLayout.LayoutParams(
                        LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
                center_params.addRule(RelativeLayout.CENTER_IN_PARENT);
                layoutItem.addView(layoutCenter, center_params);

                if (i > 0) {
                    LinearLayout.LayoutParams params = createButtonLayoutParams();
                    params.topMargin = mAttrs.otherButtonSpacing;

                    mPanel.addView(layoutItem, params);
                } else {
                    mPanel.addView(layoutItem);
                }
            }
        }
    ...
    private Attributes readAttribute() {
        ...
        attrs.actionSheetImageMarginRight = a.getDimensionPixelSize(R.styleable.ActionSheet_actionSheetImageMarginRight, (int) attrs.actionSheetImageMarginRight);
    ...
    private int[] getOtherButtonImages() {
        return getArguments().getIntArray(ARG_OTHER_BUTTON_IMAGES);
    }
    ...
    private static class Attributes {
        ...
        public Attributes(Context context) {
            ...
            this.actionSheetImageMarginRight = dp2px(24);
        }
        ...
        int actionSheetImageMarginRight;
    ...
    public static class Builder {
        ...
        private int[] mOtherButtonImageResIDs;
        ...
        public Builder setOtherButtonImageResources(int... imageIds) {
            mOtherButtonImageResIDs = imageIds;
            return this;
        }
        ...
        public Bundle prepareArguments() {
            ...
            bundle.putIntArray(ARG_OTHER_BUTTON_IMAGES, mOtherButtonImageResIDs);
            bundle.putBoolean(ARG_CANCELABLE_ON_TOUCH_OUTSIDE,
